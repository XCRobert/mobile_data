...
$ python3 get_verify_server_result.py /opt/test_tools/base/faceunlock_test_general_meil/result/i_enroll.txt /opt/test_tools/base/faceunlock_test_general_meil/result/i_real.txt /opt/test_tools/base/faceunlock_test_general_meil/result/verify452-3.55.csv 
'''
...
if __name__ == '__main__':
    ...
    servers.get_verify_server_result(options.names, options.files, options.scores,
                                     score=options.score,
